		...
		<section class="bg-white">
			<div class="container py-2 h-100">
				<div class="row d-flex justify-content-center align-items-center">
					...
					<div class="col-md-6">
						<img src='<c:url value="/security/img/login.jpg" />' alt="Image"
							class="img-fluid me-3 custom_image ">
					</div>
					<div class="col-md-6">
									...
									<div class="mb-3">
										<div class="form-floating">
											<input type="text" id="username" name="username"
												...
												placeholder="Username" /> <label class="form-label">User
												Name</label>
										</div>
									</div>
									<div class="mb-3">
										<div class="form-floating">
											<input type="password" id="password" name="password"
												...
												placeholder="Password" /> <label class="form-label">Password</label>
										</div>
									</div>
									<div class="form-check d-flex justify-content-start mb-4">
										<input class="form-check-input me-2" type="checkbox"
											name="remember-me" id="form1Example3" /> <label
											class="form-check-label"> Remember password? </label> <a
											href="/security/forgot-password"
											class="ms-auto text-decoration-none">Forgot password?</a>
									</div>
									<div class="d-grid gap-2 mb-2">
										<button type="submit" id="submit"
											class="btn btn-lg rounded-3 btn-primary">Sign In</button>
									</div>
									<hr class="my-4">
	...
	fill: #ffffff
			...
			<div class="col-md-7 offset-md-4 text-end mb-3">
				<div class="d-inline">
					...
					<a href="/security/register"
						class="text-primary text-decoration-none d-inline"><b>
							Đăng ký</b></a>
				</div>
			</div>
		</section>
