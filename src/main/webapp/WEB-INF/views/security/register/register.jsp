...
<head>
	...
	<script>
		function validateForm() {
			...
			var phoneNumberInput = document.getElementById("floatingPhoneNumber");
			var emailInput = document.getElementById("floatingEmail");
			var userNameInput = document.getElementById("floatingUsername");
			var passwordInput = document.getElementById("password");
			var retypeInput = document.getElementById("floatingRetype");

			var isValidSurname = validateSurname(surnameInput);
			var isValidName = validateName(nameInput);
			var isValidPhoneNumber = validatePhoneNumber(phoneNumberInput);
			var isValidEmail = validateEmail(emailInput);
			var isValidUserName = validateUserName(userNameInput);
			var isValidPassword = validatePassword(passwordInput);
			var isPasswordMatch = passwordInput.value === retypeInput.value;

			var submitButton = document.getElementById("submit");
			submitButton.disabled = !(isValidSurname && isValidName && isValidPhoneNumber && isValidEmail && isValidUserName && isValidPassword && isPasswordMatch);
		}
							...
							<div class="">
								<div class="mb-3">
									<div class="form-floating">
										<input type="text" name="surname" id="floatingSurname"
											   class="form-control rounded-3" required="required"
											   placeholder="Surname" oninput="validateForm();"/> <label for="floatingSurname">Surname</label>
									</div>
									<div class="alert">
									...
									<div class="mb-3">
										<div class="form-floating">
											<input type="text" name="name" id="floatingName"
												   class="form-control rounded-3" required="required"
												   placeholder="Name" oninput="validateForm();" /> <label for="floatingName">Name</label>
										</div>
										<div class="alert">
										...
										<div class="mb-3">
											<div class="form-floating">
												<input type="text" name="phoneNumber" id="floatingPhoneNumber"
													   class="form-control rounded-3" required="required"
													   placeholder="Phonenumber" oninput="validateForm();"/> <label for="floatingPhoneNumber">Phonenumber</label>
											</div>
											<div class="alert">
										...
										<div class="mb-3  ">
											<div class="form-floating">
												<input type="email" name="email" id="floatingEmail"
													   class="form-control rounded-3" required="required"
													   placeholder="name@example.com" oninput="validateForm();" /> <label
										...
										<div class="mb-3">
											<div class="form-floating">
												<input type="text" name="username" id="floatingUsername"
													   class="form-control rounded-3" required="required"
													   placeholder="Username" oninput="validateForm();"/> <label for="floatingUsername">Username</label>
											</div>
											<div class="alert">
											...
											<div class="mb-3  ">
												<div class="form-floating">
													<input type="password" id="password" name="password"
														   ...
														   oninput="validateForm();" /> <label for="password">Password:
												</label>
													<div class="alert">
											...
											<div class="mb-3">
												<div class="form-floating">
													<input type="password" id="floatingRetype" name="retype"
														   class="form-control  rounded-3" required="required"
														   minlength="8" oninput="validateForm();"
